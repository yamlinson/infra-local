...
// Resource definition
source "proxmox" "ubuntu-server-jammy-watershed" {
    ...
    node = "watershed"
    vm_id = "8101"
    vm_name = "ubuntu-server-jammy-watershed"
    ...
    cloud_init = true
    cloud_init_storage_pool = "pool01"
...
build {
    ...
    name = "ubuntu-server-jammy-watershed"
    sources = ["source.proxmox.ubuntu-server-jammy-watershed"]
